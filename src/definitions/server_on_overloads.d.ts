...
type EventNameByMode<Mode extends ServerGraphMode> = {
  [K in keyof ServerEventPayloads]: K extends keyof typeof NODE_TYPE_BY_METHOD
    ? (typeof NODE_TYPE_BY_METHOD)[K] extends Mode
      ? K
      : never
    : K
}[keyof ServerEventPayloads]

type ModeEventName<Mode extends ServerGraphMode, Name extends keyof ServerEventPayloads> = Extract<
  EventNameByMode<Mode>,
  Name
>
